...
<div class="grid-container full-width">
    <div class="grid-x grid-padding-x full-background full-background-xl" style = "background: url(http://pt-blog-2020.local/wp-content/uploads/2020/04/about-header.jpg);  background-position: top center;background-repeat: no-repeat;background-attachment: scroll; background-size: cover;">
        ...
        <div class = "grid-container padding-bottom padding-top">
            <div class="grid-x grid-padding-x primary-background">
                <div class="large-12 cell padding-top">
                    ...
                    <p class = "no-margin no-padding padding-bottom">Dr. Trenton J. Stewart is the lead pastor of Foothills Church in Maryville, Tenn. The church is the heart and vision of Pastor Trent who planted FC in 2009 with the support of Grace Baptist Church in Knoxville and Pastor Trent’s father, Dr. Ron Stewart – the longtime lead pastor of GBC.
                    ...
                    <p class = "no-margin no-padding padding-bottom">Today, Pastor Trent shares the hope of Jesus to over 2,000 people weekly as part of two Sunday services. God’s provision for the heart of FC has helped fuel it to become one of the fastest-growing churches in the area – growing in attendance by more than 20 percent from 2019-20. FC has been a sending church through The North American Mission Board to help plant churches in the U.S. FC has also sent missionaries to London, and Africa through International Mission Board. In 2018 the FC School of Ministry was developed to equip leaders and pastors to lead God's church.
